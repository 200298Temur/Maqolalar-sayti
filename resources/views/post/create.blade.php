            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('posts.store')}}" method="post">
                        ...
                        <div class="my-3">
                            <textarea name="text" placeholder="Content" id="editor" cols="30" rows="10" class="border-gray-300 shadow-sm w-1/2 rounded-lg">
                            </textarea>
                        </div>
                        ...
                        <button class="bg-slate-700 hover:bg-slate-600 text-sm rounded-md px-5 py-3">
                            Submit
                        </button> 
                    </form>
                </div>
